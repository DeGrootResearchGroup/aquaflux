...
from aquaflux.solve import Convergence, RootSolver, assembler_residual, relative_residual_gmres
...
def developing(assembler: MomentumContinuity, rtol: float) -> jnp.ndarray:
    ...
    return RootSolver(
        max_steps=200, convergence=Convergence(rtol=rtol, atol=0.0), strategy=continuation
